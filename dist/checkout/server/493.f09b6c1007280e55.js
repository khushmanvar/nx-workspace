...
/* harmony export */   provideServerRendering: function() { return /* binding */ provideServerRendering; },
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 2002);
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/platform-browser */ 8555);
/* harmony import */ var _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser/animations */ 2679);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/common/http */ 6055);
 ...
 */
class DominoAdapter extends _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["ɵBrowserDomAdapter"] {
  constructor() {
    super(...arguments);
  ...
  static makeCurrent() {
    setDomTypes();
    (0,_angular_common__WEBPACK_IMPORTED_MODULE_1__["ɵsetRootDomAdapter"])(new DominoAdapter());
  }
  createHtmlDocument() {
...
class PlatformState {
  ...
  static #_ = this.ɵfac = function PlatformState_Factory(t) {
    return new (t || PlatformState)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__.DOCUMENT));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](PlatformState, [{
...
class ServerXhr {
  ...
  ɵloadImpl() {
    ...
    return (0,_home_khush_test_org_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this.xhrImpl) {
        const {
          default: xhr
        } = yield __webpack_require__.e(/*! import() */ 165).then(__webpack_require__.t.bind(__webpack_require__, /*! xhr2 */ 165, 19));
        _this.xhrImpl = xhr;
      }
    })();
  }
  ...
  static #_ = this.ɵfac = function ServerXhr_Factory(t) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ServerXhr, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable
  }], null, null);
})();
function relativeUrlsTransformerInterceptorFn(request, next) {
  const platformLocation = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.inject)(_angular_common__WEBPACK_IMPORTED_MODULE_1__.PlatformLocation);
  const {
    href,
    protocol,
    hostname,
...
const SERVER_HTTP_PROVIDERS = [{
  ...
  provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["ɵHTTP_ROOT_INTERCEPTOR_FNS"],
 ...
 * @publicApi
 */
const INITIAL_CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken('Server.INITIAL_CONFIG');
/**
 ...
 * @publicApi
 */
const BEFORE_APP_SERIALIZED = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken('Server.RENDER_MODULE_HOOK');
...
class ServerPlatformLocation {
  constructor(_doc, _config) {
    ...
    this.search = '';
    this.hash = '';
    this._hashUpdate = new rxjs__WEBPACK_IMPORTED_MODULE_6__.Subject();
  ...
  getBaseHrefFromDOM() {
    return (0,_angular_common__WEBPACK_IMPORTED_MODULE_1__["ɵgetDOM"])().getBaseHref(this._doc);
  }
  onPopState(fn) {
  ...
  static #_ = this.ɵfac = function ServerPlatformLocation_Factory(t) {
    return new (t || ServerPlatformLocation)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__.DOCUMENT), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](INITIAL_CONFIG, 8));
  };
  static #_2 = this.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ServerPlatformLocation, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable
  }], () => [{
    type: undefined,
    decorators: [{
...
class ServerEventManagerPlugin extends _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__.EventManagerPlugin {
  constructor(doc) {
    super(doc);
    this.doc = doc;
  }
  ...
  addEventListener(element, eventName, handler) {
    return (0,_angular_common__WEBPACK_IMPORTED_MODULE_1__["ɵgetDOM"])().onAndCancel(element, eventName, handler);
  }
  static #_ = this.ɵfac = function ServerEventManagerPlugin_Factory(t) {
    return new (t || ServerEventManagerPlugin)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common__WEBPACK_IMPORTED_MODULE_1__.DOCUMENT));
  };
  static #_2 = this.ɵprov = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ServerEventManagerPlugin, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.Injectable
  }], () => [{
    type: undefined,
    decorators: [{
...
const TRANSFER_STATE_SERIALIZATION_PROVIDERS = [{
  ...
  deps: [_angular_common__WEBPACK_IMPORTED_MODULE_1__.DOCUMENT, _angular_core__WEBPACK_IMPORTED_MODULE_2__.APP_ID, _angular_core__WEBPACK_IMPORTED_MODULE_2__.TransferState],
  multi: true
}];
...
class ServerTransferStateModule {
  static #_ = this.ɵfac = function ServerTransferStateModule_Factory(t) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ServerTransferStateModule, [{
...
const INTERNAL_SERVER_PLATFORM_PROVIDERS = [{
  ...
  useValue: _angular_common__WEBPACK_IMPORTED_MODULE_1__["ɵPLATFORM_SERVER_ID"]
}, {
  ...
  deps: [_angular_common__WEBPACK_IMPORTED_MODULE_1__.DOCUMENT, [_angular_core__WEBPACK_IMPORTED_MODULE_2__.Optional, INITIAL_CONFIG]]
}, {
...
{
  provide: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵALLOW_MULTIPLE_PLATFORMS"],
  useValue: true
}];
...
const SERVER_RENDER_PROVIDERS = [{
  provide: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__.EVENT_MANAGER_PLUGINS,
  multi: true,
...
const PLATFORM_SERVER_PROVIDERS = [TRANSFER_STATE_SERIALIZATION_PROVIDERS, SERVER_RENDER_PROVIDERS, SERVER_HTTP_PROVIDERS, {
  ...
  provide: _angular_common__WEBPACK_IMPORTED_MODULE_1__.ViewportScroller,
  useClass: _angular_common__WEBPACK_IMPORTED_MODULE_1__["ɵNullViewportScroller"]
}];
/**
 ...
 */
class ServerModule {
  static #_ = this.ɵfac = function ServerModule_Factory(t) {
  ...
  static #_3 = this.ɵinj = /* @__PURE__ */_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
    ...
    imports: [_angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClientModule, _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__.NoopAnimationsModule, _angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__.BrowserModule]
  });
}
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](ServerModule, [{
    type: _angular_core__WEBPACK_IMPORTED_MODULE_2__.NgModule,
    args: [{
      exports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__.BrowserModule],
      imports: [_angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClientModule, _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__.NoopAnimationsModule],
      providers: PLATFORM_SERVER_PROVIDERS
    }]
  }], null, null);
})();
function _document(injector) {
  ...
  if (config && config.document) {
    ...
    document = (0,_angular_common__WEBPACK_IMPORTED_MODULE_1__["ɵgetDOM"])().createHtmlDocument();
  }
 ...
 * @publicApi
 */
const platformServer = (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.createPlatformFactory)(_angular_core__WEBPACK_IMPORTED_MODULE_2__.platformCore, 'server', INTERNAL_SERVER_PLATFORM_PROVIDERS);
/**
...
function provideServerRendering() {
  return (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__.makeEnvironmentProviders)([(0,_angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__.provideNoopAnimations)(), ...PLATFORM_SERVER_PROVIDERS]);
}
...
function appendSsrContentIntegrityMarker(doc) {
  ...
  const comment = doc.createComment(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵSSR_CONTENT_INTEGRITY_MARKER"]);
...
function appendServerContextInfo(applicationRef) {
  ...
  applicationRef.components.forEach(componentRef => {
    const renderer = componentRef.injector.get(_angular_core__WEBPACK_IMPORTED_MODULE_2__.Renderer2);
 ...
 */
function _render2() {
  _render2 = (0,_home_khush_test_org_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (platformRef, applicationRef) {
    const environmentInjector = applicationRef.injector;
    // Block until application is stable.
    yield (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵwhenStable"])(applicationRef);
    const platformState = platformRef.injector.get(PlatformState);
    if (applicationRef.injector.get(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵIS_HYDRATION_DOM_REUSE_ENABLED"], false)) {
      const doc = platformState.getDocument();
      appendSsrContentIntegrityMarker(doc);
      (0,_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵannotateForHydration"])(applicationRef, doc);
    }
 ...
 */
const SERVER_CONTEXT = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.InjectionToken('SERVER_CONTEXT');
/**
...
function _renderModule() {
  _renderModule = (0,_home_khush_test_org_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (moduleType, options) {
    const {
      document,
      url,
...
function _renderApplication() {
  _renderApplication = (0,_home_khush_test_org_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (bootstrap, options) {
...
const VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_2__.Version('17.0.5');
...
;
//# sourceMappingURL=493.f09b6c1007280e55.js.map